...
RSpec.feature 'Users', type: :feature do
  ...
  describe 'user' do
    ...
    let!(:menu1) do
      create(:daily_menu, created_at: 2.days.ago, food_items_attributes: food_items_attributes)
    end
    let!(:menu2) do
      create(:daily_menu, created_at: 1.day.ago, food_items_attributes: food_items_attributes)
    end
